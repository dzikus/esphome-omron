...
static constexpr OmronUserMemoryLayout UNUSED_USER = {0, 0, 0, 0, 0, 0, 0};
...
static constexpr OmronProfile PROFILE_CATALOG[] = {
    ...
    },
    {
        ...
        .users = {{{0x02E8, 30, 0x00, 0x04, 0x00FF, 0x4000, -1}, UNUSED_USER}},
        .user_count = 1,
    ...
    },
    {
        ...
        .time_region_start = 0x2C,
        .time_region_end = 0x3C,
        .users = {{{0x02E8, 100, 0x00, 0x04, 0x00FF, 0x4000, -1}, {0x0860, 100, 0x02, 0x06, 0x00FF, 0x4000, -1}}},
        .user_count = 2,
    ...
    },
    {
        ...
        .time_region_start = 0x2C,
        .time_region_end = 0x3C,
        .users = {{{0x02E8, 14, 0x00, 0x04, 0x00FF, 0x4000, -1}, UNUSED_USER}},
        .user_count = 1,
    ...
    },
    {
        ...
        .time_region_start = 0x2C,
        .time_region_end = 0x3C,
        .users = {{{0x0098, 80, 0x00, 0x04, 0x00FF, 0x4000, -1}, UNUSED_USER}},
        .user_count = 1,
    ...
    },
    {
        ...
        .time_region_start = 0x2C,
        .time_region_end = 0x3C,
        .users = {{{0x0098, 60, 0x00, 0x04, 0x00FF, 0x4000, -1}, {0x0458, 60, 0x02, 0x06, 0x00FF, 0x4000, -1}}},
        .user_count = 2,
    ...
    },
    {
        ...
        .time_region_start = 0x2C,
        .time_region_end = 0x3C,
        .users = {{{0x02E8, 60, 0x00, 0x04, 0x00FF, 0x4000, -1}, {0x06A8, 60, 0x02, 0x06, 0x00FF, 0x4000, -1}}},
        .user_count = 2,
    ...
    },
    {
        ...
        .users = {{{0x02AC, 60, 0x00, 0x04, 0x00FF, 0x4000, -1}, {0x05F4, 60, 0x02, 0x06, 0x00FF, 0x4000, -1}}},
        .user_count = 2,
    ...
    },
    {
        ...
        .time_region_start = 0x14,
        .time_region_end = 0x1E,
        .users = {{{0x02AC, 100, 0x00, 0x04, 0x00FF, 0x4000, -1}, {0x0824, 100, 0x02, 0x06, 0x00FF, 0x4000, -1}}},
        .user_count = 2,
    ...
    },
    {
        ...
        .time_region_start = 0x2C,
        .time_region_end = 0x3C,
        .users = {{{0x0098, 100, 0x00, 0x04, 0x00FF, 0x4000, -1}, {0x06D8, 100, 0x02, 0x06, 0x00FF, 0x4000, -1}}},
        .user_count = 2,
    ...
    },
    {
        ...
        .time_region_start = 0x2C,
        .time_region_end = 0x3C,
        .users = {{{0x02E8, 90, 0x00, 0x04, 0x00FF, 0x4000, -1}, UNUSED_USER}},
        .user_count = 1,
    ...
    },
    {
        ...
        .users = {{{0x02AC, 90, 0x00, 0x04, 0x00FF, 0x4000, -1}, UNUSED_USER}},
        .user_count = 1,
    ...
    // HEM-7600T field for field, hundred-slot ring.
    {
        ...
        .time_region_start = 0x14,
        .time_region_end = 0x1E,
        .users = {{{0x02AC, 100, 0x00, 0x04, 0x00FF, 0x4000, -1}, UNUSED_USER}},
        .user_count = 1,
    ...
    // is surfaced in the log at setup.
    {
        ...
        .users = {{{0x041A, 350, 0x00, 0x04, 0x3FFF, 0x4000, -1}, {0x0000, 0, 0x00, 0x00, 0x0000, 0x0000, 0}}},
        .user_count = 1,
    ...
    // catalog carries, by a factor of three.
    {
        ...
        .time_region_start = 0,
        .time_region_end = 0,
        .users = {{{0x041A, 1000, 0x00, 0x04, 0x3FFF, 0x4000, -1}, {0x0000, 0, 0x00, 0x00, 0x0000, 0x0000, 0}}},
        .user_count = 1,
    ...
    },
    {
        ...
        // and a one-slot bias.
        .users = {{{0x01C4, 60, 0x00, 0x04, 0x00FF, 0x4000, -1}, UNUSED_USER}},
        .user_count = 1,
    ...
    },
    {
        ...
        .time_region_end = 70,
        .users = {{{0x02F0, 100, 0x00, 0x04, 0x00FF, 0x4000, -1}, UNUSED_USER}},
        .user_count = 1,
    ...
    },
    {
        ...
        // agree on.
        .users = {{{0x1350, 100, 0x06, 0x0E, 0x3FFF, 0x4000, 0}, {0x0000, 0, 0x00, 0x00, 0x0000, 0x0000, 0}}},
        .user_count = 1,
    ...
    },
    {
        ...
        .time_region_start = 0,
        .time_region_end = 0,
        .users = {{{0x5590, 100, 0x06, 0x0E, 0x3FFF, 0x4000, 0}, {0x0000, 0, 0x00, 0x00, 0x0000, 0x0000, 0}}},
        .user_count = 1,
    ...
    },
    {
        ...
        .time_region_start = 0x14,
        .time_region_end = 0x1E,
        .users = {{{0x0370, 100, 0x00, 0x04, 0x00FF, 0x4000, -1}, UNUSED_USER}},
        .user_count = 1,
    ...
    },
    {
        ...
        .time_region_start = 0x14,
        .time_region_end = 0x1E,
        .users = {{{0x0370, 100, 0x00, 0x04, 0x00FF, 0x4000, -1}, {0x08E8, 100, 0x02, 0x06, 0x00FF, 0x4000, -1}}},
        .user_count = 2,
    ...
    },
    {
        ...
        .time_region_start = 0x2C,
        .time_region_end = 0x3C,
        .users = {{{0x02E8, 60, 0x00, 0x04, 0x00FF, 0x4000, -1}, UNUSED_USER}},
        .user_count = 1,
    ...
    },
    {
        ...
        .time_region_start = 0x2C,
        .time_region_end = 0x3C,
        .users = {{{0x0098, 60, 0x00, 0x04, 0x00FF, 0x4000, -1}, UNUSED_USER}},
        .user_count = 1,
    ...
    // HEM-7150T field for field, hundred-slot ring.
    {
        ...
        .time_region_start = 0x2C,
        .time_region_end = 0x3C,
        .users = {{{0x0098, 100, 0x00, 0x04, 0x00FF, 0x4000, -1}, UNUSED_USER}},
        .user_count = 1,
    ...
    },
    {
        ...
        .time_region_start = 0x2C,
        .time_region_end = 0x3C,
        .users = {{{0x01C4, 100, 0x00, 0x04, 0x00FF, 0x4000, -1}, {0x0804, 100, 0x02, 0x06, 0x00FF, 0x4000, -1}}},
        .user_count = 2,
    ...
    },
    {
        ...
        .users = {{{0x080C, 60, 0x00, 0x04, 0x00FF, 0x4000, -1}, {0x0BCC, 60, 0x02, 0x06, 0x00FF, 0x4000, -1}}},
        .user_count = 2,
    ...
    },
    {
        ...
        .time_region_start = 0x30,
        .time_region_end = 0x40,
        .users = {{{0x080C, 100, 0x00, 0x04, 0x00FF, 0x4000, -1}, {0x0E4C, 100, 0x02, 0x06, 0x00FF, 0x4000, -1}}},
        .user_count = 2,
    ...
    },
    {
        ...
        .time_region_start = 0x2C,
        .time_region_end = 0x3C,
        .users = {{{0x02E8, 100, 0x00, 0x04, 0x00FF, 0x4000, -1}, {0x0928, 100, 0x02, 0x06, 0x00FF, 0x4000, -1}}},
        .user_count = 2,
    ...
    },
    {
        ...
        .time_region_start = 0x2C,
        .time_region_end = 0x3C,
        .users = {{{0x01C4, 30, 0x00, 0x04, 0x00FF, 0x4000, -1}, UNUSED_USER}},
        .user_count = 1,
    ...
    },
    {
        ...
        .time_region_start = 0x2C,
        .time_region_end = 0x3C,
        .users = {{{0x01C4, 60, 0x00, 0x04, 0x00FF, 0x4000, -1}, {0x0584, 60, 0x02, 0x06, 0x00FF, 0x4000, -1}}},
        .user_count = 2,
    ...
    },
    {
        ...
        .time_region_start = 0x30,
        .time_region_end = 0x40,
        .users = {{{0x080C, 80, 0x00, 0x04, 0x00FF, 0x4000, -1}, {0x0D0C, 80, 0x02, 0x06, 0x00FF, 0x4000, -1}}},
        .user_count = 2,
    ...
    },
    {
        ...
        .time_region_start = 0x14,
        .time_region_end = 0x1E,
        .users = {{{0x02AC, 90, 0x00, 0x04, 0x00FF, 0x4000, -1}, {0x0798, 90, 0x02, 0x06, 0x00FF, 0x4000, -1}}},
        .user_count = 2,
